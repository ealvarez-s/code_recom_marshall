...
C--------------------------------------------------------------------------
     ...
     &           ilig5 = nvars_base+nvars_calc+nvars_iron_photo+5)
      ...
      parameter (ifecoll = nvars_base+nvars_calc+nvars_iron_photo+
     &           nvars_iron_lig+1)
#else
      ...
      parameter (idust = nvars_base+nvars_calc+nvars_iron_photo+
     &    nvars_iron_lig+nvars_iron_lig2+nvars_iron_coll+1)
      parameter (ipart = nvars_base+nvars_calc+nvars_iron_photo+
     &    nvars_iron_lig+nvars_iron_lig2+nvars_iron_coll+2)
      ...
      parameter (id1 =  nvars_base+nvars_calc+nvars_iron_photo+
     &    nvars_iron_lig+nvars_iron_lig2+nvars_iron_coll+
     &    nvars_iron_lith+1)
      parameter (id1d = nvars_base+nvars_calc+nvars_iron_photo+
     &    nvars_iron_lig+nvars_iron_lig2+nvars_iron_coll+
     &    nvars_iron_lith+2)
#else
