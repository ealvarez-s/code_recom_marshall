...
C---------------------
C Marshall et al 2002 model of photoinhibition
#undef RECOM_MARSHALL
#undef ALPHA_MARSHALL		    
C---------------------		    
C Photodegradation of chlorophyll
#define RECOM_DAMAGE_SATURATING
#undef RECOM_DAMAGE_LINEAR2
#undef RECOM_DAMAGE_LINEAR		    
C---------------------		    
